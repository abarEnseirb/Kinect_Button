...
namespace Kinect_Architecture
{
    class KinectMain
    {
        ...
        public KinectMain(Grid global, Image curseur_image, Ellipse rond, HoverButton kinectButton, Button button1, Button button2, Button quitButton)
        {
            curseur = new Curseur(global, curseur_image, rond, kinectButton, button1, button2, quitButton);
